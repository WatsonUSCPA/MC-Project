...
const Subscription = () => (
  <>
    <div className="container">
      <h1 style={{ color: 'var(--color-primary)', fontSize: '1.6rem', marginBottom: '0.5rem' }}>📦 サブスクリプション</h1>
      ...
      <div className="main-content" style={{ background: 'var(--color-background-alt)', padding: '3rem', borderRadius: 20, boxShadow: '0 4px 8px rgba(255, 159, 124, 0.08)', marginBottom: '3rem', border: '1px solid var(--color-border)' }}>
